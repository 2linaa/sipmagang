            ...
            <tbody>
              ...
              foreach ($getinternship as $intern) { ?>
                <tr>
                  ...
                  <td>
                    <a href="<?= base_url('uploads/surat/' . $intern['surat']); ?>" target="_blank"><i data-feather="file" aria-hidden="true"></i>
                    </a>

                    <a href="<?= base_url('uploads/surat/' . $intern['rekomendasi']); ?>" target="_blank"><i data-feather="file" aria-hidden="true"></i></a>
                  </td>
                  <td>
                    <?= $intern['status_penerimaan'] == 'diterima' ? '<span class="badge badge-success">Diterima</span>' : '<span class="badge badge-warning">Belum Diterima</span>'; ?>
                  </td>
                  <td>
                    <?php if ($intern['status_penerimaan'] != 'diterima')  ?>
                    ...
                    <span class="p-relative">
                      ...
                      <ul class="users-item-dropdown dropdown">
                        <li>
                          <?php if ($intern['status_penerimaan'] != 'diterima') { ?>
                            <a href="<?= base_url('internship/confirm/' . $intern['id']); ?>" class="btn btn-success btn-sm" onclick="return confirm('Konfirmasi penerimaan magang ini?');">
                              Konfirmasi
                            </a>
                          <?php } ?>
                        </li>
